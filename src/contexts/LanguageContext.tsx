...
const translations = {
    en: {
        ...
        "animation.info":
            "💡 Tip: Animation automatically normalizes path points and sizes for smooth morphing. Export the optimized paths.",
    ...
    ko: {
        ...
        "animation.info":
            "💡 팁: 애니메이션은 부드러운 모핑을 위해 패스 포인트와 크기를 자동으로 정규화합니다. 최적화된 패스를 내보내세요.",
